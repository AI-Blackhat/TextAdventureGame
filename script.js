...
let userInput = prompt(q1); // nothing will happen

// NESTED CONDITIONAL STATEMENTS
// 1ST Conditional Statement
// NOTE: Prompts return the value entered as a string. That is why double equals == is used instead of triple equals (AKA Strict Equality). Just look at face value.
if (userInput == 1){
  userInput = prompt(q2);
